...
(function(){
  ...
  const STORAGE_KEY = 'math-concepts-lab:v2.0:progress';
  let activeStep = 0;
  ...
  function renderHome(){
    ...
    app.innerHTML = `
      <section class="hero">
        <div class="hero-main">
          <p class="eyebrow">v2.0 stable class 1–10 release</p>
  ...
  function renderGuide(){
    app.innerHTML = `<section class="page-hero"><div><p class="eyebrow">Guide</p><h1>How to use this lab</h1><p class="lead">v2.0 is the stable Class 1–10 release. Use class-wise learning, activities, bridge coaching, exam readiness, chapter mini tests, and progress tracking. Printable worksheets are intentionally excluded in this version.</p></div></section><section class="section"><div class="info-grid"><div class="panel"><h3>For Class 1–2</h3><p>Ask the learner to count objects aloud. Do not rush to symbols.</p></div><div class="panel"><h3>For Class 3–5</h3><p>Use grids, bars, money, clocks, and step-by-step word problems.</p></div><div class="panel bridge-panel"><h3>For Class 6–8</h3><p>Use the Bridge Coach: prerequisite → familiar idea → school form → why → slow solve → misconception check.</p></div><div class="panel"><h3>For Class 9–10</h3><p>Use graphs, formulas, and structured exam-style solutions.</p></div><div class="panel mistake"><h3>Rule for visuals</h3><p>Visual, number sentence, explanation, and answer must match exactly.</p></div><div class="panel teacher"><h3>Teacher mode</h3><p>First ask: “What do you see?” Then ask: “How will you write it as numbers?”</p></div></div></section>`;
  }
